...
///Check if the value of the dropdown is "All" and if it's the case do not filter the commits array\\\
...
<article class=" box media">
    ...
    <div class="media-content">
        <div class="content">
            <p> <strong>
                    <?php echo $commit["committer_name"]; ?></strong>
                <small>@
                    <?php echo $commit["login"]; ?></small>
                <small> committed
                    <?php echo $timeAgo($commit["date"]); ?> </small>
                <br />
                <?php 
