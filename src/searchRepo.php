...
<section class="section">
    ...
    <div class="card-content">
        ...
        <div class="level-left">
            <p class="title is-4"><a href=<? echo "/index.php/?url=" . $result['url'] . "/commits" ?>><? echo $result['name'] ?></a><p>
        </div>
        <div class="level-right">
        <div> <? echo $result['stars'] ?> </div>
        <span class="icon star-icon is-small"><i class="fas fa-star"></i></span>
        </div>
        </div>
    <div class="content">
    <p class="subtitle is-6"><? echo $result['description'] ?></p>
    </div>
    </div>
    </div>
    </div>
